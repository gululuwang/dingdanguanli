...
import { FYBXDJCustomQueryEntryFrmProxy } from '../../models/fybxdjcustomqueryentryfrmproxy';
...
@Component({
    ...
    providers: [
        ...
        UriService,
        FYBXDJCustomQueryEntryFrmProxy,
        FYBXDJCustomQueryEntryFrmRepository,
        ...
        { provide: FORM_ID, useValue: "12357f55-9431-4e4e-ad45-fdc96d0b4501" },
