...
import { FYBXDJCXRoutingModule } from './routing';
...
@NgModule({
    ...
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcx/'},
...
export class FYBXDJCXModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcx/i18n/', '.json');
}