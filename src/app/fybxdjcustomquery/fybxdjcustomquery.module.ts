...
import { FYBXDJCustomQueryRoutingModule } from './routing';
...
@NgModule({
    ...
    imports: [
        ...
        FYBXDJCustomQueryRoutingModule,
    ],
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcustomquery/'},
        FinishLoadService,
...
export class FYBXDJCustomQueryModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcustomquery/i18n/', '.json');
}