...
import { FYBXDJCustomQueryFrmRepository } from '../../models/fybxdjcustomqueryfrmrepository';
...
import { FYBXDJCustomQueryFrmProxy } from '../../models/fybxdjcustomqueryfrmproxy';
...
@Component({
    ...
    providers: [
        ...
        { provide: Repository, useExisting: FYBXDJCustomQueryFrmRepository },
        LangService,
        ...
        UriService,
        FYBXDJCustomQueryFrmProxy,
        FYBXDJCustomQueryFrmRepository,
        ...
        { provide: FORM_ID, useValue: "786cc644-cd0f-4308-aba9-b333c6867da0" },
...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    fieldConfigsqueryscheme1 = [
        {
            "id": "13f76785-6f05-42f6-a055-9d3c53f35425",
            "labelCode": "ID",
            "code": "ID",
            "name": this.langService.transform('QueryScheme/query-scheme-1/13f76785-6f05-42f6-a055-9d3c53f35425', this.lang, "ID"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/13f76785-6f05-42f6-a055-9d3c53f35425/placeHolder', this.lang, ""),
            "control": {"controltype":"text","require":false,"className":""}
        },
        {
            "id": "8cd3213a-1492-41fe-9c67-654407dff6cd",
            "labelCode": "emp",
            "code": "emp",
            "name": this.langService.transform('QueryScheme/query-scheme-1/8cd3213a-1492-41fe-9c67-654407dff6cd', this.lang, "报销人"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/8cd3213a-1492-41fe-9c67-654407dff6cd/placeHolder', this.lang, ""),
            "control": {"controltype":"text","require":false,"className":""}
        },
        {
            "id": "97924c87-a4fd-458a-b8b5-7a400f66729f",
            "labelCode": "org",
            "code": "org",
            "name": this.langService.transform('QueryScheme/query-scheme-1/97924c87-a4fd-458a-b8b5-7a400f66729f', this.lang, "所属部门"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/97924c87-a4fd-458a-b8b5-7a400f66729f/placeHolder', this.lang, ""),
            "control": {"controltype":"text","require":false,"className":""}
        }]
...
QdpFrameworkQueryNameqdpframeworkcomponent = this.langService.transform('qdp-framework-component', this.lang, "报销单自定义查询对象");
}