...
@Injectable()
@NgCommandHandler({
    commandName: 'fxbxdfjcomponentviewmodelBatchDownloadByDataIds1'
})
export class fxbxdfjcomponentviewmodelBatchDownloadByDataIds1Handler extends CommandHandler {
    constructor(
