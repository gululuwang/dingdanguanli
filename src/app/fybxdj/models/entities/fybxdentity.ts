...
import { BillStateF798Entity } from './billstatef798entity';
import { ProcessInstanceDec3Entity } from './processinstancedec3entity';
...
export class FYBXDEntity extends Entity {
    ...
    @NgField({
        ...
        dataField: 'subject_MULTILANGUAGE',
        originalDataFieldType: 'String',
    ...
    @NgObject({
        ...
        type: BillStateF798Entity
    })
    billState: BillStateF798Entity;
    @NgObject({
        dataField: 'processInstance',
        originalDataField: 'ProcessInstance',
        type: ProcessInstanceDec3Entity
    })
    processInstance: ProcessInstanceDec3Entity;
}