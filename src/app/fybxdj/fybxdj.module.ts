...
import {
  ...
  EditorProviders
} from "@farris/ui-datagrid-editors";
...
import { FYBXDJRoutingModule } from "./routing";
...
import { FybxdmxComponent } from "./components/fybxdmx-component/fybxdmxcomponent";

import { FxbxdfjComponent } from "./components/fxbxdfj-component/fxbxdfjcomponent";

import { FYBXDC5mpComponent } from "./components/fybxd-c5mp-component/fybxdc5mpcomponent";
...
@NgModule({
  ...
  imports: [
    ...
    TranslateModule.forRoot({
      ...
      missingTranslationHandler: {
        ...
        useClass: JitMissingTranslationHandler
      }
    }),
    VerifyDetailModule,
    FarrisTooltipModule,
    ...
    DatagridModule.forRoot([...EditorProviders]),
  ...
  providers: [
    ...
    FileViewerService,
    {
      provide: FORM_PATH_TOKEN,
      useValue: "/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdj/"
    },
    FinishLoadService,
    {
      provide: Server_Host,
...
export function createTranslateLoader(http: HttpClient) {
  return new TranslateHttpLoader(
    http,
    "/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdj/i18n/",
    ".json"
  );
}
