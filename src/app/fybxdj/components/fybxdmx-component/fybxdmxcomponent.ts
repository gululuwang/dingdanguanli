            ...
            [
                {
                    ...
                    field: 'detailDate',
                    width: 120,
                    title: this.langService.transform('detailDate_eedd91e4_udbb', this.lang, "费用日期"),
                    dataType: 'datetime',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"detailDate_eedd91e4_od1q","title":"日期选择","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.DATEPICKER","dateRange":false,"showTime":true,"showType":1,"dateFormat":"yyyy-MM-dd HH:mm:ss","returnFormat":"yyyy-MM-dd HH:mm:ss","placeholder":"","showWeekNumbers":false,"editable":true,"linkedLabelEnabled":false,"linkedLabelClick":""}
                    },
                    sortable: true,
                    footer: {
                ...
                },
                {
                    ...
                    field: 'amount',
                    width: 120,
                    title: this.langService.transform('amount_39d389fe_li64', this.lang, "报销金额"),
                    dataType: 'number',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"amount_39d389fe_3quf","title":"数值框","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.NUMBERBOX","precision":2,"step":1,"canNull":true,"bigNumber":false,"showButton":true,"showZero":true}
                    },
                    sortable: true,
                    footer: {
                ...
                },
                {
                    ...
                    field: 'invoiceNumer',
                    width: 120,
                    title: this.langService.transform('invoiceNumer_7de3f793_a171', this.lang, "发票号码"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"invoiceNumer_7de3f793_au9a","title":"文本","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.TEXTBOX","isPassword":false,"maxLength":36}
                    },
                    sortable: true,
                ...
                },
                {
                    ...
                    field: 'note',
                    width: 120,
                    title: this.langService.transform('note_0b71525a_vzq3', this.lang, "费用说明"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"note_0b71525a_w8dj","title":"多行文本框","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.TEXTAREA","editType":"default","enableWordCount":false,"countType":"surplus","onlyShowInDialog":false}
                    },
                    sortable: true,
                    footer: {
