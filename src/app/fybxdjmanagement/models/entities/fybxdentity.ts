...
import { BillStateE777Entity } from './billstatee777entity';
import { ProcessInstance2bddEntity } from './processinstance2bddentity';
...
export class FYBXDEntity extends Entity {
    ...
    @NgObject({
        ...
        type: BillStateE777Entity
    })
    billState: BillStateE777Entity;
    @NgObject({
        dataField: 'processInstance',
        originalDataField: 'ProcessInstance',
        type: ProcessInstance2bddEntity
    })
    processInstance: ProcessInstance2bddEntity;
}