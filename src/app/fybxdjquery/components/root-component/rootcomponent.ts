...
import { FYBXDJQueryRepository } from '../../models/fybxdjqueryrepository';
...
import { FYBXDJQueryProxy } from '../../models/fybxdjqueryproxy';
...
@Component({
    ...
    providers: [
        ...
        { provide: Repository, useExisting: FYBXDJQueryRepository },
        LangService,
        ...
        { provide: FORM_ID, useValue: "2d53189e-a6be-48df-b212-8dd8ca783ab1" },
...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    fieldConfigsqueryscheme1 = [
        {
            "id": "e32e9a6a-840b-4496-9154-0ea2b9e496f2",
            "labelCode": "ID",
            "code": "ID",
            "name": this.langService.transform('QueryScheme/query-scheme-1/e32e9a6a-840b-4496-9154-0ea2b9e496f2', this.lang, "ID"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/e32e9a6a-840b-4496-9154-0ea2b9e496f2/placeHolder', this.lang, ""),
            "control": {"controltype":"text","require":false,"className":""}
        },
        {
            "id": "7fc48a21-7368-41e6-9395-c08da6925fdd",
            "labelCode": "organization",
            "code": "organization",
            "name": this.langService.transform('QueryScheme/query-scheme-1/7fc48a21-7368-41e6-9395-c08da6925fdd', this.lang, "组织"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/7fc48a21-7368-41e6-9395-c08da6925fdd/placeHolder', this.lang, ""),
            "control": {
                "controltype": "help",
                "require": false,
                "uri": "FYBXDJQuery.organization",
                "textField": "name",
                "valueField": "name",
                "idField": "id",
                ...
                "editable": false,
                "dialogTitle": this.langService.transform('QueryScheme/query-scheme-1/7fc48a21-7368-41e6-9395-c08da6925fdd/control/help/dialogTitle', this.lang, ""),
                "singleSelect": true,
                "enableCascade": false,
                "pageSize": 20,
        ...
        {
            "id": "47dac0eb-8364-4f6e-b6be-758d7191ff22",
            "labelCode": "employee",
            "code": "employee",
            "name": this.langService.transform('QueryScheme/query-scheme-1/47dac0eb-8364-4f6e-b6be-758d7191ff22', this.lang, "人员"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/47dac0eb-8364-4f6e-b6be-758d7191ff22/placeHolder', this.lang, ""),
            "control": {
                "controltype": "help",
                "require": false,
                "uri": "FYBXDJQuery.employee",
                "textField": "name",
                "valueField": "name",
                "idField": "id",
                ...
                "enableFullTree": false,
                "editable": false,
                "dialogTitle": this.langService.transform('QueryScheme/query-scheme-1/47dac0eb-8364-4f6e-b6be-758d7191ff22/control/help/dialogTitle', this.lang, ""),
                "singleSelect": true,
                "enableCascade": false,
                "pageSize": 20,
                "pageList": "10,20,30,50,100",
        ...
        {
            "id": "f5f93ce3-344c-4fdc-be2a-8d63d1e201b8",
            "labelCode": "totalMoney",
            "code": "totalMoney",
            "name": this.langService.transform('QueryScheme/query-scheme-1/f5f93ce3-344c-4fdc-be2a-8d63d1e201b8', this.lang, "报销总额"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/f5f93ce3-344c-4fdc-be2a-8d63d1e201b8/placeHolder', this.lang, ""),
            "control": {"controltype":"text","require":false,"className":""}
        },
        {
            "id": "5733ee90-fc45-49c1-868c-947498cd0cf7",
            "labelCode": "limitMoney",
            "code": "limitMoney",
            "name": this.langService.transform('QueryScheme/query-scheme-1/5733ee90-fc45-49c1-868c-947498cd0cf7', this.lang, "报销限额"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/5733ee90-fc45-49c1-868c-947498cd0cf7/placeHolder', this.lang, ""),
            "control": {"controltype":"text","require":false,"className":""}
        }]
