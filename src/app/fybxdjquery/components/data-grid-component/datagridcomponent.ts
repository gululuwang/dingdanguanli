            ...
            [
                {
                    ...
                    field: 'organization',
                    width: 120,
                    title: this.langService.transform('organization_7fc48a21_ugdf', this.lang, "组织"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                ...
                },
                {
                    ...
                    field: 'employee',
                    width: 120,
                    title: this.langService.transform('employee_47dac0eb_eab3', this.lang, "人员"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                ...
                },
                {
                    ...
                    field: 'totalMoney',
                    width: 120,
                    title: this.langService.transform('totalMoney_f5f93ce3_ig1x', this.lang, "报销总额"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                ...
                },
                {
                    ...
                    field: 'limitMoney',
                    width: 120,
                    title: this.langService.transform('limitMoney_5733ee90_m790', this.lang, "报销限额"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
