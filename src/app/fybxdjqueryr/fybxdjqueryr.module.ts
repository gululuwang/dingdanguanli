...
import { FYBXDJQueryRRoutingModule } from './routing';
...
@NgModule({
    ...
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjqueryr/'},
        FinishLoadService,
...
export class FYBXDJQueryRModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjqueryr/i18n/', '.json');
}