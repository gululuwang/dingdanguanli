...
import { FYBXDJQueryRFrmRepository } from '../../models/fybxdjqueryrfrmrepository';
...
import { FYBXDJQueryRFrmProxy } from '../../models/fybxdjqueryrfrmproxy';
...
@Component({
    ...
    providers: [
        ...
        { provide: Repository, useExisting: FYBXDJQueryRFrmRepository },
        LangService,
        ...
        UriService,
        FYBXDJQueryRFrmProxy,
        FYBXDJQueryRFrmRepository,
        ...
        { provide: FORM_ID, useValue: "fa23fd30-9efc-45d3-b3e6-a791e4358f8b" },
