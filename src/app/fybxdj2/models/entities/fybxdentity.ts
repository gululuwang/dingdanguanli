...
import { BillStateE46fEntity } from './billstatee46fentity';
import { ProcessInstance65ddEntity } from './processinstance65ddentity';
...
export class FYBXDEntity extends Entity {
    ...
    @NgObject({
        ...
        type: BillStateE46fEntity
    })
    billState: BillStateE46fEntity;
    @NgObject({
        dataField: 'processInstance',
        originalDataField: 'ProcessInstance',
        type: ProcessInstance65ddEntity
    })
    processInstance: ProcessInstance65ddEntity;
}