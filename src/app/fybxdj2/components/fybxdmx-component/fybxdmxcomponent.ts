...
export class FybxdmxComponent extends FrameComponent implements OnInit, AfterViewInit {
            ...
            [
                {
                    ...
                    field: 'detailDate',
                    width: 120,
                    title: this.langService.transform('detailDate_6f7d777b_0jwn', this.lang, "费用日期"),
                    dataType: 'datetime',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"detailDate_6f7d777b_kela","title":"日期选择","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.DATEPICKER","dateRange":false,"showTime":true,"showType":1,"dateFormat":"yyyy-MM-dd HH:mm:ss","returnFormat":"yyyy-MM-dd HH:mm:ss","placeholder":"","showWeekNumbers":false,"editable":true,"linkedLabelEnabled":false,"linkedLabelClick":""}
                    },
                    sortable: true,
                    footer: {
                ...
                },
                {
                    ...
                    field: 'amount',
                    width: 120,
                    title: this.langService.transform('amount_d5bd1403_qui3', this.lang, "报销金额"),
                    dataType: 'number',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"amount_d5bd1403_ksm6","title":"数值框","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.NUMBERBOX","precision":2,"step":1,"canNull":true,"bigNumber":false,"showButton":true,"showZero":true}
                    },
                    sortable: true,
                    footer: {
                ...
                },
                {
                    ...
                    field: 'invoiceNumer',
                    width: 120,
                    title: this.langService.transform('invoiceNumer_2972ead7_coko', this.lang, "发票号码"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"invoiceNumer_2972ead7_3f24","title":"文本","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.TEXTBOX","isPassword":false,"maxLength":36}
                    },
                    sortable: true,
                    footer: {
                ...
                },
                {
                    ...
                    field: 'note',
                    width: 120,
                    title: this.langService.transform('note_122eea01_jnep', this.lang, "费用说明"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"note_122eea01_18l7","title":"多行文本框","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.TEXTAREA","editType":"default","enableWordCount":false,"countType":"surplus","onlyShowInDialog":false}
                    },
                    sortable: true,
                    footer: {
