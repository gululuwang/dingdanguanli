...
import { ROBXDJChenshjForm3RoutingModule } from './routing';
...
@NgModule({
    ...
    imports: [
        ...
        ROBXDJChenshjForm3RoutingModule,
    ],
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjchenshjfront/robxdjchenshjform3/'},
        FinishLoadService,
...
export class ROBXDJChenshjForm3Module {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjchenshjfront/robxdjchenshjform3/i18n/', '.json');
}