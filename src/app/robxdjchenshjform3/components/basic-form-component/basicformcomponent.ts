...
export class BasicFormComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    totalSum_45b2b624_cvzc_PlaceHolder = this.langService.transform('NumericBox/totalSum_45b2b624_cvzc/placeHolder', this.lang, "");
    totalSum45b2b624CvzcTextOptions = {
        "type": "number",
        "useThousands": true,
        "precision": 2,
    }
    billType_77cd12de_kg0hEnumData = [
        {
            "name": this.langService.transform('EnumField/billType_77cd12de_kg0h/enumData/CL', this.lang, "差旅费"),
            "value": "CL"
        },
        {
            "name": this.langService.transform('EnumField/billType_77cd12de_kg0h/enumData/SJ', this.lang, "手机费"),
            "value": "SJ"
        },
        {
            "name": this.langService.transform('EnumField/billType_77cd12de_kg0h/enumData/JT', this.lang, "交通费"),
            "value": "JT"
        }
    ];
    billType_77cd12de_kg0h_PlaceHolder = this.langService.transform('EnumField/billType_77cd12de_kg0h/placeHolder', this.lang, "");
    code_9b3cfccc_673s_PlaceHolder = this.langService.transform('TextBox/code_9b3cfccc_673s/placeHolder', this.lang, "");
    employee_Employee_Name_0e18e40e_p3rc_PlaceHolder = this.langService.transform('TextBox/employee_Employee_Name_0e18e40e_p3rc/placeHolder', this.lang, "");
    department_Department_name_b9c6e9a5_uo07_PlaceHolder = this.langService.transform('TextBox/department_Department_name_b9c6e9a5_uo07/placeHolder', this.lang, "");
}