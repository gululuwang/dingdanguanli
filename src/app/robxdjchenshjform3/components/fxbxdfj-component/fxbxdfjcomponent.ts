            ...
            [
                {
                    ...
                    field: 'fileName',
                    width: 120,
                    title: this.langService.transform('fileName_bf12f155_vj53', this.lang, "文件名"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"fileName_bf12f155_uxch","title":"多行文本框","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.TEXTAREA","enableWordCount":false,"countType":"surplus","onlyShowInDialog":false}
                    },
                    sortable: true,
                    footer: {
                ...
                },
                {
                    ...
                    field: 'filePath',
                    width: 120,
                    title: this.langService.transform('filePath_96ab041a_gbcz', this.lang, "文件路径"),
                    dataType: 'string',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        type: EditorTypes.TEXTAREA,
                        options: {"id":"filePath_96ab041a_n5kh","title":"多行文本框","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.TEXTAREA","enableWordCount":false,"countType":"surplus","onlyShowInDialog":false}
                    },
                    sortable: true,
                    footer: {
                ...
                },
                {
                    ...
                    field: 'fileSize',
                    width: 120,
                    title: this.langService.transform('fileSize_587bc7c4_yb8b', this.lang, "文件大小"),
                    dataType: 'number',
                    align: 'left',
                    halign: 'left',
                    valign: 'middle',
                    ...
                    editor: {
                        ...
                        options: {"id":"fileSize_587bc7c4_mxx2","title":"数值框","placeHolder":"","readonly":false,"localization":null,"localizationType":null,"type":"EditorTypes.NUMBERBOX","precision":2,"step":1,"canNull":true,"bigNumber":false,"showButton":true,"showZero":true}
                    },
                    sortable: true,
                    footer: {
