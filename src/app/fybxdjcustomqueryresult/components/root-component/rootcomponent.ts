...
import { FYBXDJCustomQueryResultFrmRepository } from '../../models/fybxdjcustomqueryresultfrmrepository';
...
import { FYBXDJCustomQueryResultFrmProxy } from '../../models/fybxdjcustomqueryresultfrmproxy';
...
@Component({
    ...
    providers: [
        ...
        { provide: Repository, useExisting: FYBXDJCustomQueryResultFrmRepository },
        LangService,
        ...
        UriService,
        FYBXDJCustomQueryResultFrmProxy,
        FYBXDJCustomQueryResultFrmRepository,
        ...
        { provide: FORM_ID, useValue: "e783f36b-70a7-42d5-8b68-d8f683602a03" },
