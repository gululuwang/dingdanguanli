...
import { FYBXDJCustomQueryResultRoutingModule } from './routing';
...
@NgModule({
    ...
    imports: [
        ...
        FYBXDJCustomQueryResultRoutingModule,
    ],
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcustomqueryresult/'},
        FinishLoadService,
...
export class FYBXDJCustomQueryResultModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcustomqueryresult/i18n/', '.json');
}