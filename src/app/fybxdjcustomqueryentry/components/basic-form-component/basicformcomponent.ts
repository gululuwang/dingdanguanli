...
import { FYBXDJCustomQueryEntryFrmRepository } from '../../models/fybxdjcustomqueryentryfrmrepository';
...
@Component({
    ...
    providers: [
        ...
        { provide: Repository, useExisting: FYBXDJCustomQueryEntryFrmRepository },
        LangService,
...
export class BasicFormComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    emp_202c708f_nx6h_PlaceHolder = this.langService.transform('TextBox/emp_202c708f_nx6h/placeHolder', this.lang, "");
    org_e82e807a_1t1d_PlaceHolder = this.langService.transform('TextBox/org_e82e807a_1t1d/placeHolder', this.lang, "");
}