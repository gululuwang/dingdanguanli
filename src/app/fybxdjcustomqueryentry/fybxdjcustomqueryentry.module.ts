...
import { FYBXDJCustomQueryEntryRoutingModule } from './routing';
...
@NgModule({
    ...
    imports: [
        ...
        FYBXDJCustomQueryEntryRoutingModule,
    ],
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcustomqueryentry/'},
        FinishLoadService,
...
export class FYBXDJCustomQueryEntryModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjchenshjfront/fybxdjcustomqueryentry/i18n/', '.json');
}